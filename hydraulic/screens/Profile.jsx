      ...
      <View style={style.container}>
        ...
        <View style={style.profileContainer}>
          ...
          <Text style={style.name}>
            {userLogin === true ? userData.username : "Hesabınıza Giriş Yapın"}
          </Text>

          {userLogin === false ? (
            <TouchableOpacity onPress={() => navigation.navigate("Login")}>
              <View style={style.loginBtnContainer}>
                <Text style={style.menuText}>Giriş Yap</Text>
              </View>
            </TouchableOpacity>
          ) : (
            ...
            <View style={style.menuWrapper}>
              ...
              <TouchableOpacity onPress={() => navigation.navigate("Orders")}>
                <View style={style.menuItem(0.2)}>
                  <MaterialCommunityIcons
                    ...
                    size={24}
                  />
                  <Text style={style.menuText}>Siparişler</Text>
                </View>
              </TouchableOpacity>
              ...
              <TouchableOpacity onPress={() => navigation.navigate("Cart")}>
                <View style={style.menuItem(0.2)}>
                  <SimpleLineIcons
                    ...
                    size={24}
                  />
                  <Text style={style.menuText}>Sepetim</Text>
                </View>
              </TouchableOpacity>
              ...
              <TouchableOpacity onPress={() => clearCache()}>
                <View style={style.menuItem(0.2)}>
                  <MaterialCommunityIcons
                    ...
                    size={24}
                  />
                  <Text style={style.menuText}>Belleği Temizle</Text>
                </View>
              </TouchableOpacity>
              ...
              <TouchableOpacity onPress={() => deleteAccount()}>
                <View style={style.menuItem(0.2)}>
                  <AntDesign
                    ...
                    size={24}
                  />
                  <Text style={style.menuText}>Hesabı Sil</Text>
                </View>
              </TouchableOpacity>
              ...
              <TouchableOpacity onPress={() => logout()}>
                <View style={style.menuItem(0.2)}>
                  ...
                  <Text style={style.menuText}>Çıkış Yap</Text>
                </View>
              </TouchableOpacity>
            </View>
          )}
